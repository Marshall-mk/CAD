...
from utils_microscopicmamba import create_lr_scheduler,EarlyStopping,seed
...
def main():
    ...
    train_set_path = r"../../../dataset/3_class_train/"
    val_set_path = r"../../../dataset/3_class_val/"
    ...
    model_name = 'microscopicmamba_t_multi_class'
    ...
    for epoch in range(epochs):
        ...
        if not os.path.exists(
                "./microscopicmamba_multi_CELoss_Adam_metrics.csv"
            ):
            pd.DataFrame(
                columns=[
                    "Epoch",
