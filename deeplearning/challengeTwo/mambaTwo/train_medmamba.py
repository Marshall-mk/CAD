...
def main():
    ...
    train_path = "../../../dataset/3_class_train/"
    val_path = "../../../dataset/3_class_val/"
    ...
    class_weights = torch.tensor([1.0 / class_counts[name] for name in class_names], dtype=torch.float).to(device)
    ...
    best_acc = 0.0
    best_loss = float('inf')
    save_path = './mamba_skinMultiCELoss_AdamNet.pth'
    ...
    for epoch in range(epochs):
        ...
        # Log metrics
        metrics_file = "./mamba_multi_CELoss_Adam_metrics.csv"
        ...
        try:
            plot_confusion_matrix(conf_matrix, classes=class_names, title="Validation Confusion Matrix")
            plt.savefig(f"./mamba_multi_CELoss_Adam_confusion_matrix_epoch_{epoch + 1}.png")
