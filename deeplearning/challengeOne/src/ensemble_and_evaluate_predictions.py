...
convit_small_preds = np.loadtxt('../metrics/convit_small_val_predictions.txt', dtype=int)
...
convit_small_probs = np.loadtxt('../metrics/convit_small_val_probabilities.txt')
